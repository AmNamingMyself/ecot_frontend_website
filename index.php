									...
									<figcaption class="tg-slidercontent">
										<div class="tg-slidercontentbox">
											...
											<div class="tg-titledescription">
												...
												<div class="tg-description"><p>We equip beyond concepts &amp; designs but build buildings which brings about the best of the vocational design and building skills acquired at the College...</p></div>
											</div>
										</div>
									</figcaption>
							  </figure>
									...
									<figcaption class="tg-slidercontent">
										<div class="tg-slidercontentbox">
											...
											<div class="tg-titledescription">
												...
												<div class="tg-description"><p>A welcoming environment always brings about creativity and enhances critical thinking for students, that&acute;s we provide the top class environment for research...</p></div>
											</div>
										</div>
									</figcaption>
							  </figure>
									...
									<figcaption class="tg-slidercontent">
										<div class="tg-slidercontentbox">
											...
											<div class="tg-titledescription">
												...
												<div class="tg-description"><p>For a practical or more hands on experience we encourage students to partake in actual feel of the real industry in exploring their capabilities and innovative thinking...</p></div>
											</div>
										</div>
									</figcaption>
							  </figure>
									...
									<figcaption class="tg-slidercontent">
										<div class="tg-slidercontentbox">
											...
											<div class="tg-titledescription">
												...
												<div class="tg-description"><p>The college has it&acute;s own campus that houses students who opt for staying on camp but it is not a mandotory option. One can feel free to stay on camp or not...</p></div>
											</div>
										</div>
									</figcaption>
							  </figure>
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
											<div class="tg-glanceatuoeandk tg-glanceatuoeandkvtwo">
												...
												<ul class="tg-gallery">
													...
													<li>
														<figure>
															<a class="tg-btnview" href="images/glance/img-23.jpg" data-rel="prettyPhoto[glance]"><i class="icon-magnifier"></i></a>
															<img src="images/glance/img-23a.jpg" alt="image description">
														</figure>
													</li>
													<li>
														<figure>
															<a class="tg-btnview" href="images/glance/img-24.jpg" data-rel="prettyPhoto[glance]"><i class="icon-magnifier"></i></a>
															<img src="images/glance/img-24a.jpg" alt="image description">
														</figure>
													</li>
													<li>
														<figure>
															<a class="tg-btnview" href="images/glance/img-25.jpg" data-rel="prettyPhoto[glance]"><i class="icon-magnifier"></i></a>
															<img src="images/glance/img-25a.jpg" alt="image description">
														</figure>
													</li>
													<li>
														<figure>
															<a class="tg-btnview" href="images/glance/img-26.jpg" data-rel="prettyPhoto[glance]"><i class="icon-magnifier"></i></a>
															<img src="images/glance/img-26a.jpg" alt="image description">
														</figure>
													</li>
													<li>
														<figure>
															<a class="tg-btnview" href="images/glance/img-27.jpg" data-rel="prettyPhoto[glance]"><i class="icon-magnifier"></i></a>
															<img src="images/glance/img-27a.jpg" alt="image description">
														</figure>
													</li>
												</ul>
											</div>
